...
const StatsCard = ({headerTitle, total, 
    currentMonthCount, lastMonthCount} : StatsCard) => {
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                        ...
                        <figcaption className={cn("text-sm font-medium", 
                         ...
                         <p className="text-sm font-medium truncate">vs last month</p>
                </div>
            </div>
            <img src = {`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg'}`}
            className="xl:w-32 w-full h-full md:h-32 xl:h-4" alt="trend graph" />
            </div>      
    </article>
  )
}
